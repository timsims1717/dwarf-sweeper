...
func NewDwarf() *Dwarf {
	...
	tran.Pos = pixel.V(16 * world.TileSize, -9 * world.TileSize)
	d := &Dwarf{
		Transform:  physicsT,
	}
...
func (d *Dwarf) Update() {
	...
	d.grounded = ((dwn1 != nil && dwn1.Solid) || (dwnlw != nil && dwnlw.Solid) || (dwnrw != nil && dwnrw.Solid)) && d.Transform.Pos.Y <= loc1.Transform.Pos.Y+1.0
	if d.Hurt {
		if d.dmg > 0 {
